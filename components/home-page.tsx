...
export function HomePage() {
  ...
  return (
    <div className="gradient-bg min-h-screen bg-background text-foreground">
      <div className="mx-auto max-w-6xl px-6 pb-24 pt-10 sm:px-10">
        ...
        <Section id="proof" className="mt-16">
          <div className="rounded-3xl border border-border bg-card/90 p-8 shadow-sm backdrop-blur">
            <h2 className="text-2xl font-semibold">Proof</h2>
            <p className="mt-3 text-muted-foreground">
              Recruiter-friendly proof: focus op aantoonbare impact, traceability en duidelijke delivery.
            </p>
        ...
        <Section id="projects" className="mt-16">
          <div className="flex items-end justify-between gap-4">
            ...
            <p className="text-sm text-muted-foreground">Top 3 + extra projecten voor scope.</p>
          </div>
        ...
        <Section id="contact" className="mt-16">
          <div className="flex flex-col gap-6 rounded-3xl border border-border bg-card/90 p-8 shadow-sm backdrop-blur md:flex-row md:items-center md:justify-between">
            <div>
              <h2 className="text-2xl font-semibold">Contact</h2>
              <p className="mt-2 text-muted-foreground">
                Open voor part-time rollen, hybride teams en freelance opdrachten.
              </p>
            </div>
